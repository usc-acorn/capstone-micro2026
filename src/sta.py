...
from archipelago.translate_application_graph_into_RTL import translate_application_graph_into_RTL
...
def main():
    ...
    # Call translate_application_graph_into_RTL
    dirname = os.path.dirname(packed_file)
    translate_application_graph_into_RTL(routing_result_graph, output_file=os.path.join(dirname, "application_graph.v"), data_width=16)
